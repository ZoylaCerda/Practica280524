package sv.edu.ufg.fis.amb.ContentProviderRamosAragon
...
class MainActivity : AppCompatActivity() {
    ...
    private fun createImageUri():Uri {
        ...
        return FileProvider.getUriForFile(this,"sv.edu.ufg.fis.amb.ContentProviderRamosAragon.fileProvide",imagen)
    }
